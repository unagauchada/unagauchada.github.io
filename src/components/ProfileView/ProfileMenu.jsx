...
export default class ProfileMenu extends PureComponent {
  ...
  filterPublications = user => publication => {
    return (
      publication.user === user && !publication.blocked && !publication.canceled
    )
  }
          ...
          {(this.props.user === this.props.currentUser.uid ||
            ...
            <Tab label="Publicaciones">
              <FilteredPublicationList
                filter={this.filterPublications(this.props.user)}
              />
            </Tab>}
          {(this.props.user === this.props.currentUser.uid ||
            this.state.currentUser.admin) &&
            <Tab label="Postulaciones">
              {this.state.submissions &&
                <FilteredPublicationList
                  filter={this.filterSubmissions(this.props.user)}
                />}
            </Tab>}
          {this.props.user === this.props.currentUser.uid &&
            this.state.currentUser.admin &&
            <Tab label="Publicaciones Reportadas">
              <FilteredPublicationList
                canReport={true}
                filter={this.filterReportedPublications(this.state.reports)}
              />
            </Tab>}
          {this.props.user === this.props.currentUser.uid &&
            this.state.currentUser.admin &&
